...
<body>
	<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12 main">
		<a href="${pageContext.request.contextPath}/crew/search.action"><strong><span class="fa fa-users"></span> Data Karyawan</strong></a> / Tambah Data Karyawan
      	<hr>
      	<div class="errors">
		...
		<s:form namespace="/crew" method="POST" theme="bootstrap" cssClass="form-horizontal">
			...
			<hr>
		  	<div class="footer">
				...
				<s:submit action="SaveCrew" value="Save" cssClass="btn btn-primary"/>
			</div>
		</s:form>
    </div>
</body>
