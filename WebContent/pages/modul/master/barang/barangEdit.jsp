...
<body>
	<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12 main">
		<a href="${pageContext.request.contextPath}/barang/searchAllBarang.action"><strong><span class="fa fa-th-list"></span> Data Barang</strong></a> / Ubah Data Barang
      	<hr>
      	<div class="errors">
		   <s:fielderror name="invalidBarang"/>
		</div>
		<s:form namespace="/barang" method="POST" theme="bootstrap" cssClass="form-horizontal">
			<s:hidden name="barang.idBarang"/>
			...
			<hr>
		  	<div class="footer">
				...
				<s:submit action="SaveEditBarang" value="Update" cssClass="btn btn-primary"/>
			</div>
		</s:form>
    </div>
</body>
